<?php
    ...
    'games' => [
      ...
      '3oaks' => [
        'name' => '3Oaks',
        'new_api_endpoint' => env('WAINWRIGHT_CASINODOG_DOMAIN', env('APP_URL'), 'https://127.0.0.1').'/api/games/3oaks/',
        'controller' => \App\Http\Controllers\Casinodog\Game\Oaks\OaksMain::class,
        'extra_game_metadata' => 0,
        'fake_iframe_url' => 0,
        'demolink_retrieval_method' => 0, // customize the demo link retrieval used on datacontroller, if set to 1 you will need'demolink_retrieval_method () in your Main class
        'custom_entry_path' => 0,
