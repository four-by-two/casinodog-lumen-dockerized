...
class StakelogicGame extends StakelogicMain
{
	...
	if(isset($data_origin['casino'])) {
		$data_origin['casino']['brand'] = "stakelogic2";
	}

	if(isset($data_origin['operation'])) {

                $data_origin['operation']['gamebrand'] = "stakelogic2";
		if(isset($data_origin['operation']['game'])) {
			if(isset($data_origin['operation']['game']['brand'])) {
				$data_origin['operation']['game']['brand'] = "stakelogic2";
			}
		}
	}
